...
# thresholds-service Kubernetes deployment script

set -e

NAMESPACE="flet-montrg"
SERVICE_NAME="thresholds-service"
IMAGE_NAME="flet-montrg/thresholds-service:latest"
KIND_CLUSTER="flet-cluster"

echo "🚀 Starting thresholds-service deployment..."
...
echo "✅ thresholds-service deployment completed!"
echo "🌐 Service URL: http://localhost:30002"
echo "📊 API Docs: http://localhost:30002/docs"
