...
# thresholds-service Kubernetes 배포 스크립트
...
echo "✅ thresholds-service 배포 완료!"
echo "🌐 서비스 접속: http://localhost:30001"
echo "📊 API 문서: http://localhost:30001/docs"
